    ...
    <div className="min-h-screen bg-white p-4 md:p-6">
      <div className="mx-auto max-w-sm space-y-8 pt-16">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="text-sm font-medium">네이버로 로그인하기</span>
          </Button>
          ...
          >
            <span className="text-sm font-medium">카카오로 로그인하기</span>
          </Button>
          ...
          >
            <span className="text-sm font-medium">이메일로 로그인하기</span>
          </Button>
        </div>
